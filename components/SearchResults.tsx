...
import { Search, ExternalLink, MapPin, Building2, ChevronRight, Briefcase, Globe, BadgeCheck } from "lucide-react";
    ...
    <div className="flex min-h-screen justify-center pt-[56px]" style={{ background: "var(--fb-bg)" }}>
      <main className="w-full py-4 px-2 md:px-0" style={{ maxWidth: 640 }}>
        ...
        <div className="flex flex-col gap-3">
          {results.map((r, i) => <ResultCard key={`${r.source}-${r.id ?? r.applyUrl}-${i}`} r={r} />)}
        </div>
